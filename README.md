...
```hcl
module "langfuse" {
  source = "github.com/langfuse/langfuse-terraform-aws?ref=1.2.0"
...
| postgres_cluster_parameter_group_name | Name of an externally managed Aurora PostgreSQL cluster parameter group                                                                                | string       | null                                                                                  |    no    |
